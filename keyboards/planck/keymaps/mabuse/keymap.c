...
[_QWERTY] = {
  ...
  {KC_LSFT,   KC_Y,    KC_X,    KC_C,    KC_V,  KC_B,   KC_N,   KC_M,  KC_COMM, KC_DOT,   KC_SLSH, MT(MOD_LSFT, KC_ENT) },
 ...
 */
[_FUNC] = {
  {_______, DE_EURO, _______, _______, _______, _______, _______, DE_UE,   _______, DE_OE,   _______, _______ },
